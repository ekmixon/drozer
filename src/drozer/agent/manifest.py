...
class Endpoint(object):
    ...
    def write(self):
        ...
        h.write("---------------\n")
        h.write(f"host:{self.host}" + "\n")
        h.write(f"port:{str(self.port)}" + "\n")
        h.write(f"password:{self.password}" + "\n")
        h.write(f"ssl:{str(self.ssl).lower()}" + "\n")
        h.write(f"ts_path:{self.ts_path}" + "\n")
        h.write(f"ts_password:{self.ts_password}")
